    ...
    <section className="max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8 pt-40 md:pt-48 lg:pt-56 pb-16 font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16 md:mb-[120px]">
        {cards.map((card, index) => (
          <div
            key={index}
            className="bg-[#E6D7FF] rounded-2xl p-6 sm:p-8 text-left flex flex-col gap-3 sm:gap-4 transition-transform duration-300 hover:-translate-y-1"
          >
        ...
        <div className="w-full lg:w-1/2 text-left">
          ...
          <ul className="space-y-6">
            {promises.map((item, idx) => (
              ...
              >
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#77429A] flex items-center justify-center">
                  <Image
                    src={item.icon}
                    alt="icon"
                    width={16}
