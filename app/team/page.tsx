        ...
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            <div className="relative w-full h-[420px] overflow-hidden rounded-2xl">
              ...
              {/* Purple Overlay */}
              <div className="absolute inset-0 bg-[#77429AD9] m-6 border border-[#FFFFFF6B] rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center text-center px-6">
